                ...
                <div class="archive-list">
                    <ul>
                        <c:forEach var="categoryInfoVO" items="${categoryInfoVOList}" varStatus="status">
                            <li><a href="">${categoryInfoVO.categoryTitle}</a> <span>(${fn:length(categoryInfoVO.articleInfoVOList)})</span></li>
                        </c:forEach>
                    </ul>
                </div>
            </div>
            <div class="article-list">
                <c:forEach var="articleInfoVO" items="${(fn:length(categoryInfoVO.articleInfoVOList)) > 0 ? categoryInfoVO.articleInfoVOList : null}" varStatus="status">
