            ...
            <div class="archive-list">
                <ul>
                    <c:forEach var="categoryInfoVO" items="${categoryInfoVOList}" varStatus="status">
                        <li>
                            <a href="${staticDomain}/category/${categoryInfoVO.slug}" <c:if test="${categoryInfoVO.slug eq slug}">class="active"</c:if>>
                                ${categoryInfoVO.categoryTitle}
                            </a>
                ...
                <div class="article-item">
                    ...
                    <div class="article-metadata">
                        ...
                        <span class="article-category">
                            <a href="${staticDomain}/category/${articleInfoVO.categorySlug}">
                                ${articleInfoVO.categoryName}
                            </a>
                        </span>
                    ...
                    <div class="article-footer">
                        ...
                        <div class="read-more">
                            <a href="${staticDomain}/article/${articleInfoVO.articleSlug}">
                                继续阅读<i class=" icon-double-angle-right"></i>
                            </a>
                        </div>
